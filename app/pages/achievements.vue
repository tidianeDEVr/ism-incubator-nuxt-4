  ...
  meta: [
    {
      name: "description",
      content:
        "Decouvrez les projets gagnants et les success stories de l'incubateur ISM.",
    },
  ],
});
...
const years = computed(() => {
  const uniqueYears = [...new Set(mockAchievements.map((a) => a.year))].sort(
    (a, b) => b - a,
  );
  return uniqueYears;
});
  ...
  <div>
    <section class="bg-primary py-12 lg:py-16">
      <div class="container-padded">
        <div class="max-w-2xl">
          <h1 class="text-display-sm text-white mb-4">Success Stories</h1>
          <p class="text-body-lg text-white/70">
            Decouvrez les projets qui ont marque nos hackathons et inspire la
            communaute entrepreneuriale de l'ISM.
          </p>
        </div>
      </div>
    </section>
    ...
    <section class="py-12 lg:py-16">
      <div class="container-padded">
          ...
          >
            ...
            >
              ...
              <div class="absolute top-4 right-4">
                <span
                  class="px-3 py-1 rounded-full text-xs font-medium bg-white/90 text-gray-700"
                >
                  {{ achievement.year }}
                </span>
              </div>
            ...
            <div class="p-6">
              ...
              <h3
                class="text-heading-sm text-primary mb-2 group-hover:text-secondary transition-colors"
              >
                ...
                <div class="flex items-center justify-between">
                  <div class="flex items-center gap-3">
                    <div class="flex -space-x-2">
                      <UiTooltip
                        v-for="(member, index) in achievement.members.slice(
                          0,
                          4,
                        )"
                        :key="index"
                    ...
                    <div>
                      ...
                      <div class="text-caption text-gray-500">
                        {{ achievement.members.length }} membres
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div v-if="filteredAchievements.length === 0" class="text-center py-16">
          ...
          <p class="text-body text-gray-500">Aucun projet pour cette annee</p>
        </div>
      </div>
    </section>
    ...
    <section class="py-16 lg:py-20 bg-neutral-background">
      <div class="container-padded text-center">
        ...
        <p class="text-body-lg text-gray-600 mb-8 max-w-xl mx-auto">
          Participez a notre prochain hackathon et transformez votre idee en
          projet gagnant.
        </p>
