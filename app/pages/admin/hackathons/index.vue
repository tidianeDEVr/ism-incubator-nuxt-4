...
import type { Hackathon, HackathonStatus, Prize } from "~/types";
...
const modalTitle = computed(() =>
  editingHackathon.value ? "Modifier le hackathon" : "Créer un hackathon",
);
      ...
      >
        ...
        <template #actions="{ item }">
          <div class="flex items-center justify-end gap-1">
            ...
            <UiTooltip text="Dupliquer" position="left" :delay="100">
              <button
    ...
    >
      <form @submit.prevent="handleSubmit">
        ...
        <div class="flex justify-end gap-3 pt-4 border-t border-neutral-border">
          ...
          >
            {{ editingHackathon ? "Modifier" : "Créer" }}
          </UiButton>
        </div>
      </form>
    </UiModal>
